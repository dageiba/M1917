...
public class ToothpickItem extends M1917gunModElements.ModElement {
	@ObjectHolder("m1917gun:toothpick")
	public static final Item block = null;
	public ToothpickItem(M1917gunModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Item modifier", (double) -0.75, AttributeModifier.Operation.ADDITION));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u4E00\u6839\u7259\u7B7E\uFF0C\u4EC5\u6B64\u800C\u5DF2"));
		}
	}
}

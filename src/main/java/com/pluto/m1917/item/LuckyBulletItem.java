...
public class LuckyBulletItem extends M1917gunModElements.ModElement {
	@ObjectHolder("m1917gun:lucky_bullet")
	public static final Item block = null;
	public LuckyBulletItem(M1917gunModElements instance) {
		super(instance, 3);
	}

...
public class SuperToothpickItem extends M1917gunModElements.ModElement {
	@ObjectHolder("m1917gun:super_toothpick")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(M1917ItemGroup.tab).maxStackSize(64).rarity(Rarity.EPIC));
			setRegistryName("super_toothpick");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u52A0\u62FF\u5927\u8FDB\u53E3"));
		}

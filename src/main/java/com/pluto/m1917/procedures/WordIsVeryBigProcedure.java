	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				M1917gunMod.LOGGER.warn("Failed to load dependency x for procedure WordIsVeryBig!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				M1917gunMod.LOGGER.warn("Failed to load dependency y for procedure WordIsVeryBig!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				M1917gunMod.LOGGER.warn("Failed to load dependency z for procedure WordIsVeryBig!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				M1917gunMod.LOGGER.warn("Failed to load dependency world for procedure WordIsVeryBig!");
			return;
		}
